...
if __name__ == "__main__":
    # 예: experiments/brats_2018/segformer3d_mlp/chk1/config.yaml
    CONFIG_PATH = "/home/work/3D_/seondeok/project/3d_segmentation/SegFormer3D/experiments/brats_2018/segformer3d_mlp/ex1/config.yaml"
